...
public class AudioPalyer {
	...
	private OnPreparedListener mInnerOnPreparedListener = new MediaPlayer.OnPreparedListener() {
		@Override
	...
	private OnBufferingUpdateListener mInnerOnBufferingUpdateListener = new MediaPlayer.OnBufferingUpdateListener() {
		@Override
	...
	private OnCompletionListener mInnerOnCompletionListener = new MediaPlayer.OnCompletionListener() {
		@Override
